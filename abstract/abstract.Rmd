...
setwd("~/workspace/russia/rlms/papers/conference2013")
####
library(knitr)
knit("abstract.Rmd")
system("pandoc -s abstract.md -o abstract.html --bibliography=bibtex.bib")
system("pandoc abstract.md -o abstract.pdf --bibliography=bibtex.bib")

system("pandoc abstract.md -o abstract_proc.pdf --variable documentclass:proc --bibliography=bibtex.bib")
####
cd ~/workspace/russia/rlms/papers/conference2013

lftp -u np16003 -e "mirror -R;quit" ftp://np16003@www.muuankarski.org/domains/muuankarski.org/public_html/research/rlms/papers/conference2013
#lftp -u np16003 -e "put index.html;quit" ftp://np16003@www.muuankarski.org/domains/muuankarski.org/public_html/research/rlms/papers/conference2013
```
